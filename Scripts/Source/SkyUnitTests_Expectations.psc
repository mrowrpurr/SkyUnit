...
function ExpectationDataBasics_Test()
    ...
    CreateTest("MyTest")
    int expectationCount = JArray.count(SkyUnitAPI.SkyUnitData_CurrentExpectationsArray())
    ...
    expectationCount = JArray.count(SkyUnitAPI.SkyUnitData_CurrentExpectationsArray())
    string[] expectationDataKeys = JMap.allKeysPArray(SkyUnitAPI.SkyUnitData_GetCurrentExpectationDataMap())
