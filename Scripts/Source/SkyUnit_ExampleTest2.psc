scriptName SkyUnit_ExampleTest2 extends SkyUnitTest
{Example SkyUnit test used by the tests

e.g.

```
SkyUnitTestExamples.ExampleTest2().Test_PassingTest1_Enabled = true
```
...
SkyUnit_ExampleTest2 function GetInstance() global
    return Game.GetFormFromFile(0x0808, "SkyUnitTests.esp") as SkyUnit_ExampleTest2
endFunction

function ResetTests() global
    SkyUnit_ExampleTest2 test = GetInstance()
